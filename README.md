...
该代码实现思路参考arm_流水线作者的代码文件的实现思路。具体代码可以查阅参考资料【7】
...
![图片](https://user-images.githubusercontent.com/107350922/181734509-bccdcd9d-4339-444b-8e86-3635e02367c8.png)

![图片](https://user-images.githubusercontent.com/107350922/181734569-5f3caddd-2c82-4462-b29b-16e3fdf8084c.png)

经过依次对比测试结果，我们发现

SM2密钥协商测试结果与最初生成的公钥相同。

SM2数字签名值经过vrfy算法运算之后计算出的值与原来消息值相同。

SM2加解密测试中对生成的密文进行解密成功，成功还原出了原始的明文值，满足合法密码方案的可逆性。

即该project成功按RFC6979实现了国密SM2密码方案！
